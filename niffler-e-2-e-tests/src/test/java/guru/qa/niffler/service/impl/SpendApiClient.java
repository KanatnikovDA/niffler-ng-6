...
public class SpendApiClient implements SpendClient {
  ...
  public List<SpendJson> getSpends(String username, CurrencyValues currencyValues ,String from, String to) {
    final Response<List<SpendJson>> response;
    try {
      response = spendApi.allSpends(username, currencyValues, from, to)
                         .execute();
    } catch (IOException e) {
      throw new AssertionError(e);
    }
